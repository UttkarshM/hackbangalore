...
class MyFundOption extends StatelessWidget {
  final MyFund fundDetails;
  final int idx;
  const MyFundOption({super.key, required this.fundDetails, required this.idx});
              ...
              Flexible(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.file(File(fundDetails.image!.path,), fit: BoxFit.fill,) ,
                  ),
                ),
              ),
              Flexible(
